...
class ArchitectureTest {
    ...
    void noCycles() {
        // arrange
        ArchRule rule = slices().matching("de.baedorf.(tailoringexpert).(*)")
...
//    }
    ...
    void repositoriesShouldLocatedInRepository() {
        ...
        ArchRule rule = classes()
            ...
            .because("repositories shall be placed in repository package");
    ...
    @Test
    void repositorynameShouldEndWithRepository() {
        // arrange
        ArchRule rule = classes()
            .that().resideInAPackage("..repository")
            .should().haveSimpleNameEndingWith("Repository")
            .because("Repository shall be named Repository");
    ...
    void fieldInjectionNotUseAutowiredAnnotation() {
        ...
        ArchRule rule = noFields()
            ...
            .because("configuration shall be done manually");
