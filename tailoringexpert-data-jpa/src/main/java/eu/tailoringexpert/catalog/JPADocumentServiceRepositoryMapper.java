 ...
 */
@Mapper
public abstract class JPADocumentServiceRepositoryMapper {

    public abstract SelectionVectorProfile getSelectionVectorProfiles(SelectionVectorProfileEntity entity);
