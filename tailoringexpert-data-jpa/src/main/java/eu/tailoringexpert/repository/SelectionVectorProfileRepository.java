...
public interface SelectionVectorProfileRepository extends JpaRepository<SelectionVectorProfileEntity, Long> {
    ...
    /**
     * Loads a profile a a request internal (business) key.
     *
     * @param internalKey internal key of profile to load
     * @return SelectionVectorProfile entity of requested internal key
     */
    SelectionVectorProfileEntity findByInternalKey(String internalKey);
}
