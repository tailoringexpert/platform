...
class CatalogResourceTest {
    ...
    void constructor_MitLinks_ResourceWirdErstellt() {
        //arrange
        TailoringCatalogChapterResource gruppe = new TailoringCatalogChapterResource(
            "/", "1", emptyList(), emptyList(), asList(Link.of("http://localhost"))
        );

        // act
        TailoringCatalogResource actual = new TailoringCatalogResource(gruppe, asList(Link.of("http://localhost")));
    ...
    void constructor_OhneLinks_ResourceMitEmptyLinksWirdErstellt() {
        ...
        // act
        TailoringCatalogResource actual = new TailoringCatalogResource(gruppe, null);
