...
import de.baedorf.tailoringexpert.domain.DokumentResource.DokumentResourceBuilder;
import de.baedorf.tailoringexpert.domain.DokumentZeichnungResource.DokumentZeichnungResourceBuilder;
import de.baedorf.tailoringexpert.domain.KatalogResource.KatalogResourceBuilder;
import de.baedorf.tailoringexpert.domain.KatalogVersionResource.KatalogVersionResourceBuilder;
import de.baedorf.tailoringexpert.domain.PathContext.PathContextBuilder;
import de.baedorf.tailoringexpert.domain.ProjektInformationResource.ProjektInformationResourceBuilder;
import de.baedorf.tailoringexpert.domain.ProjektResource.ProjektResourceBuilder;
import de.baedorf.tailoringexpert.domain.ScreeningSheetResource.ScreeningSheetResourceBuilder;
import de.baedorf.tailoringexpert.domain.SelektionsVektorResource.SelektionsVektorResourceBuilder;
import de.baedorf.tailoringexpert.domain.TailoringAnforderungResource.TailoringAnforderungResourceBuilder;
import de.baedorf.tailoringexpert.domain.TailoringInformationResource.TailoringInformationResourceBuilder;
import de.baedorf.tailoringexpert.domain.TailoringKatalogKapitelResource.TailoringKatalogKapitelResourceBuilder;
import de.baedorf.tailoringexpert.domain.TailoringResource.TailoringResourceBuilder;
