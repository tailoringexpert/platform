...
public class AnforderungController {
    ...
    @GetMapping(value = ResourceMapper.ANFORDERUNG, produces = {"application/hal+json"})
    ...
    @PutMapping(value = ResourceMapper.ANFORDERUNG_AUSGEWAEHLT, produces = {"application/hal+json"})
    ...
    @PutMapping(ResourceMapper.ANFORDERUNG_TEXT)
    ...
    @PutMapping(ResourceMapper.KAPITEL_AUSGEWAEHLT)
    ...
    @PostMapping(value = ResourceMapper.ANFORDERUNG, produces = {"application/hal+json"})
    @SneakyThrows
    public ResponseEntity<EntityModel<TailoringAnforderungResource>> createAnforderung(
        ...
        return anforderungService.createAnforderung(projekt, tailoring, kapitel, anforderung, text)
            .map(erstellteAnforderung -> ResponseEntity
                .created(UriTemplate.of(ResourceMapper.ANFORDERUNG).expand(pathContext.build().parameter()))
