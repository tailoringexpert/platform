...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthenticationResource> authenticate(@RequestBody AuthenticationRequest authenticationRequest) {
        log.info("Authentication request for user {} received!", authenticationRequest.getUserId());

        Authentication authenticate = authenticationService.authenticate(authenticationRequest.getUserId(), authenticationRequest.getPassword());
        return ok()
