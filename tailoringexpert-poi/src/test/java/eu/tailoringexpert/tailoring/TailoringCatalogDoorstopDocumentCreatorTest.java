...
@Log4j2
class TailoringCatalogDoorstopDocumentCreatorTest {

    TailoringCatalogDoorstopDocumentCreator creator;
    ...
    void beforeEach() {
        ...
        this.creator = new TailoringCatalogDoorstopDocumentCreator();
    ...
    @Test
    void createDocument_ValidTailoringCatalog_WorkbookCreated() throws Exception {
        // arrange
        Catalog<TailoringRequirement> catalog;
        try (InputStream is = this.getClass().getResourceAsStream("/tailoringkatalog.json")) {
            assert nonNull(is);
