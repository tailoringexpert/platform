...
class RequirementsSheetCreatorTest {
    ...
    @Test
    void accept_DifferentLevelTypes_levelTypeCorrectRendered() throws IOException {
        // arrange
    ...
    void od() throws Exception {
        ...
        assertThat(sheet.getLastRowNum()).isPositive();
        assertThat(sheet.getRow(2).getCell(3).getStringCellValue()).isEqualTo("-Q6");
        assertThat(sheet.getRow(3).getCell(3).getStringCellValue()).isEqualTo("+Q6");
        assertThat(sheet.getRow(4).getCell(3).getStringCellValue()).isEqualTo("Q6");
    }
