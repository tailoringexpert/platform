...
class DRDSheetCreatorTest {
    ...
    void setup() {
        ...
        this.sheet = new XSSFWorkbook().createSheet("DRD");

        this.creator = new DRDSheetCreator();
    }
    ...
    void accept_AllInputsProvided_FileCreated() throws IOException {
        ...
        try (ByteArrayOutputStream os = new ByteArrayOutputStream()) {
            ...
            fileSaver.accept("drd.xlsx", os.toByteArray());
        }

        assertThat(sheet.getSheetName()).isEqualTo("DRD");
