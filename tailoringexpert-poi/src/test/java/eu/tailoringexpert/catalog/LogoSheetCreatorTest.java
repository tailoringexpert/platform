...
class LogoSheetCreatorTest {

    private JsonMapper objectMapper;
    private FileSaver fileSaver;
    private Sheet sheet;
    private LogoSheetCreator creator;
    ...
    void setup() {
        ...
        this.sheet = new XSSFWorkbook().createSheet("LOGO");

        this.creator = new LogoSheetCreator();
    }
    ...
    void accept_AllInputsProvided_FileCreated() throws IOException {
        ...
        try (ByteArrayOutputStream os = new ByteArrayOutputStream()) {
            ...
            fileSaver.accept("logo.xlsx", os.toByteArray());
        }

        assertThat(sheet.getSheetName()).isEqualTo("LOGO");
