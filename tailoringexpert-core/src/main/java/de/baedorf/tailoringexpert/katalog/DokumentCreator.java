...
public interface DokumentCreator {

    /**
     * Erzeugt einen druckbaren Gesamtkatalog.
     *
     * @param docId       zu verwendender Dokumentenidentifkator
     * @param katalog     Der Katalog, zu dem das Dokument erstellt werden soll
     * @param platzhalter Zusätzliche Parameter/Platzhalter, die nicht Teil des Projektphase sind
     * @return Druckbarer Dokument
     */
    Datei createDokument(String docId, Katalog<KatalogAnforderung> katalog, Map<String, String> platzhalter);
}
