...
class SpecObjectsConsumerTest {
    XmlMapper xmlMapper;
    XMLOutputFactory xmlFactory;
    SpecObjectsConsumer consumer;
    ...
    void setup() {
        ...
        this.xmlFactory = this.xmlMapper
            .tokenStreamFactory()
            .getXMLOutputFactory();
        this.consumer = new SpecObjectsConsumer();
    }

    @Test
    void accept_SpecObjects_ListConsumed() throws XMLStreamException, IOException {
        // arrange
        List<SpecObject> specObjects = List.of(
            SpecObject.builder()
                .identifier("so-1")
        ...
        consumer.accept(specObjects, generator);
        ...
        // assert
        assertThat(sw)
            .hasToString("<test><SPEC-OBJECTS><SPEC-OBJECT IDENTIFIER=\"so-1\" LAST-CHANGE=\"2026-01-01T00:00\"><TYPE><SPEC-OBJECT-TYPE-REF>st-normative</SPEC-OBJECT-TYPE-REF></TYPE><VALUES><ATTRIBUTE-VALUE-STRING THE-VALUE=\"Q-80\"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>a-document-code</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING><ATTRIBUTE-VALUE-ENUMERATION><VALUES><ENUM-VALUE-REF>v-ecss-q-st-80d software product assurance</ENUM-VALUE-REF></VALUES><DEFINITION><ATTRIBUTE-DEFINITION-ENUMERATION-REF>a-type</ATTRIBUTE-DEFINITION-ENUMERATION-REF></DEFINITION></ATTRIBUTE-VALUE-ENUMERATION><ATTRIBUTE-VALUE-BOOLEAN THE-VALUE=\"true\"><DEFINITION><ATTRIBUTE-DEFINITION-BOOLEAN-REF>a-active</ATTRIBUTE-DEFINITION-BOOLEAN-REF></DEFINITION></ATTRIBUTE-VALUE-BOOLEAN></VALUES></SPEC-OBJECT></SPEC-OBJECTS></test>");
    }
